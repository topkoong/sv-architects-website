...
const nextConfig = {
  ...
  // Image configuration - disable optimization for development to fix image loading
  images: {
    unoptimized: true, // Disable optimization for now to fix image loading
    formats: ['image/webp', 'image/avif'],
    domains: [],
    deviceSizes: [640, 750, 828, 1080, 1200, 1920, 2048, 3840],
    imageSizes: [16, 32, 48, 64, 96, 128, 256, 384],
    minimumCacheTTL: 60,
    qualities: [75, 85, 90], // Add the missing quality values
  },
