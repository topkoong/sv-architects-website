/**
 * ============================================================================
 * FILE: src/app/projects/don-mueang-airport-terminal3/page.tsx
 * ============================================================================
 * DESCRIPTION: Project detail page for Don Mueang International Airport Terminal 3
...
const project = {
  ...
  size: '160,000 sqm',
  client: 'AOT',
  tagline: 'INTERNATIONAL AVIATION HUB Bridging Heritage, Embracing the Future.',
...
export default function DonMueangAirportTerminal3Page() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    The Don Mueang International Airport Terminal 3 represents a significant 
                    expansion of Thailand's aviation infrastructure. This modern terminal 
                    seamlessly blends heritage elements with cutting-edge technology, creating 
                    an international aviation hub that serves as a gateway to Thailand while 
                    embracing the future of air travel. The project focuses on sustainable 
                    design principles and enhanced passenger experience.
                  </p>
                </div>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">Year Started</span>
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    <span className="text-black font-semibold">Project Management & Planning</span>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Explore the architectural details and design elements of the Don Mueang International Airport Terminal 3
            </p>
          </motion.div>
