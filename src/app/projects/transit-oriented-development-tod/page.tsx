...
/**
 * ============================================================================
 * TRANSIT ORIENTED DEVELOPMENT (TOD) PROJECT DETAIL PAGE
 * ============================================================================
...
const project = {
  ...
  size: '120,000 sqm',
  client: 'Bangkok Metropolitan Administration',
  tagline: 'A NEW STANDARD for Smart Growth and Urbanization utilizing a Transportation Hub',
...
/**
 * Transit Oriented Development (TOD) Project Detail Page Component
 * 
 * This component displays detailed information about the TOD project,
 ...
 * 
 * @returns {JSX.Element} The TOD project detail page
 */
export default function TransitOrientedDevelopmentPage() {
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  {project.description} Our approach for the {project.name} project focused on creating a comprehensive transportation hub that serves as a catalyst for smart urban growth and sustainable development in {project.location}.
                </p>
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-800">Transportation Integration</h4>
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  The TOD project represents a paradigm shift in urban planning, integrating multiple transportation modes including BTS, MRT, bus systems, and pedestrian networks. The skywalk systems and pedestrian bridges ensure seamless connectivity while promoting walkability and reducing vehicular dependency.
                </p>

                <h4 className="text-2xl font-semibold mb-4 text-gray-800">Smart Growth Principles</h4>
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  This master planning project implements smart growth principles by creating mixed-use developments around transportation nodes, promoting density, and ensuring sustainable urban expansion. The plaza developments serve as community gathering spaces while supporting commercial activities.
                </p>

                <h4 className="text-2xl font-semibold mb-4 text-gray-800">Client & Collaboration</h4>
                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                  This project was a successful collaboration with <strong>{project.client}</strong>. Our team worked closely with transportation authorities, urban planners, and community stakeholders to create a comprehensive master plan that addresses current needs while planning for future growth.
                </p>
