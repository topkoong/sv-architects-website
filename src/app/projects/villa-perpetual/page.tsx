/**
 * ============================================================================
 * FILE: src/app/projects/villa-perpetual/page.tsx
 * ============================================================================
 * DESCRIPTION: Project detail page for Villa Perpetual
 * Features image slider with 3 unique images and comprehensive project information
 * Luxury villa project showcasing epitome of luxury and modern elegance
 * ============================================================================
 */
...
const project = {
  ...
  tagline: 'EPITOME OF LUXURY AND MODERN ELEGANCE',
...
export default function VillaPerpetualPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Luxury Villa Excellence Section */}
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-rose-50 to-pink-50">
        <div className="container mx-auto px-4">
          <motion.div
            variants={fadeIn}
            initial="hidden"
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4 text-black">Luxury Villa Excellence</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Villa Perpetual represents the epitome of luxury and modern elegance, featuring timeless design principles, 
              premium finishes, and sophisticated living spaces that define the pinnacle of luxury villa living.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <div className="text-4xl font-bold text-rose-600 mb-4">🏰</div>
                <h3 className="text-xl font-bold mb-2 text-black">Epitome of Luxury</h3>
                <p className="text-gray-600">Timeless design principles with premium finishes and sophisticated living spaces</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <div className="text-4xl font-bold text-pink-600 mb-4">✨</div>
                <h3 className="text-xl font-bold mb-2 text-black">Modern Elegance</h3>
                <p className="text-gray-600">Modern elegance with high-end materials and luxury villa amenities</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Private Outdoor Areas</h3>
                <p className="text-gray-600">Private outdoor areas designed for sophisticated living and luxury villa experience</p>
              </div>
            </motion.div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Villa Perpetual stands as a testament to luxury villa design, embodying the epitome of luxury and modern elegance. 
                    This sophisticated residential development showcases timeless design principles combined with premium finishes, 
                    creating an unparalleled living experience that defines luxury villa living in Bangkok. Every detail has been 
                    carefully crafted to provide the ultimate in sophisticated living spaces.
                  </p>
                </div>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">Design Philosophy</span>
                    <span className="text-black font-semibold">Luxury & Elegance</span>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl font-bold mb-4 text-black">Luxury Villa Gallery</h3>
            <p className="text-lg text-gray-600">
              Explore the epitome of luxury and modern elegance in Villa Perpetual
            </p>
          </motion.div>
