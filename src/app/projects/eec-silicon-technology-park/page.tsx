/**
 * ============================================================================
 * FILE: src/app/projects/eec-silicon-technology-park/page.tsx
 * ============================================================================
 * DESCRIPTION: Project detail page for EEC Silicon Technology Park
...
const project = {
  ...
  tagline: 'COMPREHENSIVE MASTER PLAN Silicon Technology Innovation Hub',
  ...
  features: [
    ...
    'Silicon technology facilities',
    'Innovation center integration'
  ],
  images: [
...
export default function EECSiliconTechnologyParkPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <motion.div
            variants={fadeIn}
            initial="hidden"
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The EEC Silicon Technology Park represents comprehensive master planning for Thailand's Eastern Economic Corridor, 
              featuring integrated facilities, sustainable design principles, and innovation-focused development for silicon technology.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">Comprehensive master plan for silicon technology park with integrated facility planning</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Innovation Focus</h3>
                <p className="text-gray-600">Innovation-focused development with technology infrastructure and innovation center integration</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Sustainable Design</h3>
                <p className="text-gray-600">Sustainable design principles with mixed-use integration and green building standards</p>
              </div>
            </motion.div>
          </div>
        </div>
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    The EEC Silicon Technology Park stands as a flagship development within Thailand's Eastern Economic Corridor, 
                    representing a comprehensive master planning approach to silicon technology innovation. This ambitious project 
                    integrates cutting-edge facilities with sustainable design principles, creating a hub for technological advancement 
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    <span className="text-black font-semibold">Silicon Technology</span>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl font-bold mb-4 text-black">Technology Park Gallery</h3>
            <p className="text-lg text-gray-600">
              Explore the master planning and innovation facilities of the EEC Silicon Technology Park
            </p>
          </motion.div>
