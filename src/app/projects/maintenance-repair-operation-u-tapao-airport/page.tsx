/**
 * ============================================================================
 * FILE: src/app/projects/maintenance-repair-operation-u-tapao-airport/page.tsx
 * ============================================================================
 * DESCRIPTION: Project detail page for Maintenance Repair Operation U-tapao Airport (MRO)
...
const project = {
  ...
  tagline: '"SPACE WITHIN SPACE" Maintenance Repair Operation Facility',
...
export default function MaintenanceRepairOperationUTapaoAirportPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-sky-50 to-blue-50">
        <div className="container mx-auto px-4">
          <motion.div
            variants={fadeIn}
            initial="hidden"
          ...
          >
            ...
            <h2 className="text-4xl font-bold mb-4 text-black">Aviation Excellence</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The Maintenance Repair Operation U-tapao Airport facility represents innovative aviation infrastructure, 
              featuring a unique "space within space" design concept for air cargo expansion and maintenance operations.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <div className="text-4xl font-bold text-sky-600 mb-4">🔧</div>
                <h3 className="text-xl font-bold mb-2 text-black">MRO Operations</h3>
                <p className="text-gray-600">State-of-the-art aircraft maintenance, repair, and overhaul facilities with safety compliance systems</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Air Cargo Expansion</h3>
                <p className="text-gray-600">Air cargo expansion facilities designed for the air-cargo industry in Thailand</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <div className="text-4xl font-bold text-indigo-600 mb-4">🏗️</div>
                <h3 className="text-xl font-bold mb-2 text-black">Space Within Space</h3>
                <p className="text-gray-600">Innovative design concept featuring space within space architecture for operational efficiency</p>
              </div>
            </motion.div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    The Maintenance Repair Operation U-tapao Airport facility represents a groundbreaking approach to aviation 
                    infrastructure design. This innovative MRO facility incorporates a unique "space within space" design concept, 
                    creating efficient operational environments for aircraft maintenance, repair, and overhaul activities while 
                    supporting air cargo expansion for Thailand's growing air-cargo industry.
                  </p>
                </div>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">Design Concept</span>
                    <span className="text-black font-semibold">Space Within Space</span>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h3 className="text-3xl font-bold mb-4 text-black">MRO Facility Gallery</h3>
            <p className="text-lg text-gray-600">
              Explore the maintenance, repair, and operation facilities of the U-tapao Airport MRO
            </p>
          </motion.div>
