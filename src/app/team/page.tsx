            ...
            >
              ...
              <div className="px-8 pt-4 pb-8 text-center flex flex-col flex-grow relative">
                ...
                <div className="mb-8 flex-grow relative z-10">
                  <div className="flex flex-wrap gap-2 justify-center">
                    {member.skills.slice(0, 3).map((skill: string, skillIndex: number) => (
                      <span 
                        key={skillIndex}
                        className="px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-full text-xs font-semibold border border-gray-300/50 hover:from-purple-100 hover:to-purple-200 hover:text-purple-800 hover:border-purple-300/50 transition-all duration-300 group-hover:shadow-md"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-gray-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </Link>
              </div>
            </motion.article>
          ))}
                ...
                <div className="mb-6 flex-grow relative z-10">
                  <div className="flex flex-wrap gap-1.5">
                    {member.skills.slice(0, 3).map((skill: string, skillIndex: number) => (
                      <span 
                        key={skillIndex}
                        className="px-2.5 py-1.5 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-md text-xs font-medium border border-gray-300/50 hover:from-purple-100 hover:to-purple-200 hover:text-purple-800 hover:border-purple-300/50 transition-all duration-300 group-hover:shadow-sm"
                      >
                        {skill}
                      </span>
                    ))}
